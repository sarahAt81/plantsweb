...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/artt.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/artt.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/arti.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Artistic Touch</h1>
        <p class="price"><span>USD 320</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">24 Roses, Baby Roses & Other Flowers in Box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        A super seductive arrangement made from 24 roses, Baby Roses & other flowers in a box!
        <br><br>
        Shop this beautiful mixed arrangement and make any occasion unforgettable.
<br><br>
Box Size: D=30cm
<br><br>
    </p>
