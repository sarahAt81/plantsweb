...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/dr.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/dr.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/dre.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Colorfull Dreams</h1>
        <p class="price"><span>USD 116</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">50 Mixed Color Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Send this bouquet of 50 mixed colors roses, as a reflection of beauty and affect your special someone's mood. Because only the freshest roses are selected for this bouquet, actual rose colors will vary due to local availability.
    </p>
  </div>
