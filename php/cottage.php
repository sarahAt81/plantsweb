...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/cot.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/cot.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/cottn.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Country Cottage</h1>
        <p class="price"><span>USD 80</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Mixed Flowers Bouquet</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Whisk them away with this lovely 9 roses and mixed flowers abouquet that will look great on any desk or table.
    </p>
  </div>
    </body>
    <footer>
