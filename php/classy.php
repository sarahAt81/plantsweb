...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/classyre.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/classyre.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/re.png" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Classy Reflex</h1>
        <p class="price"><span>USD 79</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">32 Roses Bouquet</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Timeless, classy, and iconic, this pastel mix of roses will surely put a smile on her face with this beautiful bouquet of 32 mixed roses.
<br><br>
