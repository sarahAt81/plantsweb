...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/joyy.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/joyy.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/ffjoy.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Joyfull Box</h1>
        ...
        <p class="small-p">42 Mixed Roses in Box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Share joyful wishes with your special someone with a trendy gift of 42 mixed roses in a round black box.
<br><br>
        Box Size: D=30cm
  </div>
    </body>
