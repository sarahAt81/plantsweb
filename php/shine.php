...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/sunn.jpg" alt="Big Photo" class="big-photo">
      </div>
      <div class="product-info">
        <h1 class="product-name">Shine Bright</h1>
        ...
        <p class="small-p">16 SunFlower</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        16 Sunflower with greenery.
    </p>
  </div>
