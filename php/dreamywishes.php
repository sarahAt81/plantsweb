...
<body>
  <div class="product-page">
    <div class="header">
      <img src="photos/bouquets/dreamyww.jpg" alt="Big Photo" class="big-photo">
    </div>
    <div class="product-info">
      <h1 class="product-name">Dreamy Wishes</h1>
      ...
      <p class="small-p">Charming Mixed Flowers Bouquet</p>
    </div>
  </div>
  <div class="d">
