...
<body>
    <div class="product-page">
        <div class="header">
            <img src="photos/bouquets/whitee.jpg" alt="Big Photo" class="big-photo">
            <div class="small-photos">
                <img src="photos/bouquets/whitee.jpg" alt="Small Photo 1" class="small-photo">
                <img src="photos/bouquets/gf.jpg" alt="Small Photo 2" class="small-photo">
            </div>
        </div>
        <div class="product-info">
            <h1 class="product-name">White Heart</h1>
            ...
            <p class="small-p">100 Long Stem White Roses</p>
        </div>
    </div>
    <div class="d">
        <p class="details"><strong>Details</strong></p>
        <p class="detail">
            Capture their attention with this radiant bouquet of premium 100 long stem white roses with no additional
            greenery.
            <br><br>
            Elegantly arranged by our select florists, these symbols of eternal love will express your feelings with
