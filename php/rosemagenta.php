...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/mmg.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/mmg.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/mgn.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Rose Magneta</h1>
        ...
        <p class="small-p">42 Fuchsia Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        For the one, whom you love from all your heart, 42 fuchsia roses in a box. The passion of love, turned into a simple luxury.
<br><br>
        Box Size: D=30cm
    </p>
  </div>
