...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/ofy.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/ofy.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/youth.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Blooms Of Youth</h1>
    ...
    <p class="detail">
        Cherish the moments with beautiful 25 poly roses, a bouquet that reflects joy and happiness.
    </p>
  </div>
