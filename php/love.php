...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/lovev.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/lovev.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/luvv.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Love</h1>
    ...
    <p class="detail">
        Communicate your passion and emotion with this bouquet of 25 poly roses. Send this perfect gift as a symbol of your deep love.
    </p>
  </div>
