...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/happyy.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/happyy.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/hap.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Happy Moments</h1>
        <p class="price"><span>USD 140</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">18 Roses & Mixed Flowers in Box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Raise your glass to the happy moments outdoors; offer this gorgeous and vibrant box of 18 Roses & mixed flowers to celebrate the beautiful days!
<br><br>
        Box Size: D=20cm
<br><br>
    </p>
