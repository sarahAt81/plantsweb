...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/sunnn.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/sunnn.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/sunshinee.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Sunshine</h1>
        <p class="price"><span>USD 55</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Yellow Baby Roses & Seasonal Flowers</p>
      </div>
    </div>
    <div class="d">
    ...
    <p class="detail">
        ...
        This sunshine bouquet has a warm, welcoming look that will win over your special someone with each sunlit bloom. <br><br>
         Yellow baby roses and other mixed flowers are set to brighten their day.
    </p>
  </div>
    </body>
    <footer>
