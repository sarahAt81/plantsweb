...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/chglory.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/chglory.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/fg.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Christmas Glory</h1>
        <p class="price"><span>USD 119</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Holy Family Elegance with LED Light</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Send this spiritual gift of mixed greenery decorated with a LED micro Light and a Holy Family resin set to send a touch of grace to any home or office this Christmas!
<br><br>
        Pot Size: D20cm x H10cm
    </p>
  </div>
