...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/sweetbox.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/sweetbox.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/springsweet.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Sweet Spring</h1>
        <p class="price"><span>USD 63</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Mixed Flowers Arrangement in a Box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        This wild bouquet will create a moment your recipient will always remember! This instant mood booster is the perfect combination of bright, bold blooms and dried flowers. It includes baby roses, 6 Germini, dried flowers and greenery and will make their day the best ever.
<br><br>
