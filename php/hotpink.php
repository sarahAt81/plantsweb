...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/hott.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/hott.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/hpink.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Hot Pink</h1>
        ...
        <p class="small-p">50 Fuchsia Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Send love & passion with our truly hot bouquet of 50 fuchsia roses with no additional greenery! And let your baby girl know she's the one!
<br><br>
        Note: Shade of color may vary depending on availability.
    </p>
  </div>
    </body>
    <footer>
