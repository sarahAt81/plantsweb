...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/sup.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/sup.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/drr.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Rose Surprise</h1>
        <p class="price"><span>USD 32</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">12 Mixed Roses with Greenery</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Our exquisite bouquet of 12 assorted roses with greenery, hand-crafted by our expert florists, complements any occasion with unforgettable style.
<br><br>
