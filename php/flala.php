...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/lala.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/lala.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/fla.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Falalala</h1>
        ...
        <p class="small-p">Stunning Elegant Bouquet</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Shop this simply stunning bouquet full of 12 elegant red roses, pine cones and other flowers to bring the magic of the season to life.
    </p>
  </div>
    </body>
    <footer>
