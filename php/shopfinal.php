    ...
    <div class="fall-section ">
        ...
        <div class="product-grid">
          <div class="product">
            ...
            <p>USD 95.000</p>
            <a href="glam.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/cozybox.jpg" alt="Product 2">
            <h2>Cozy Box</h2>
            <p>USD 100.000</p>
            <a href="cozybox.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/baby.jpg" alt="Product 3">
            <h2>Baby Sprinkles</h2>
            <p>USD 142.000</p>
            <a href="sprinkles.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/fallfinal.jpg" alt="Product 4">
            <h2>Blooms Of Youth</h2>
            <p>USD 113.000</p>
            <a href="blooms.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
      ...
      <div  class="fall-sction">
        <div class="product-grid">
          <div class="product">
            ...
            <p>USD 380.000</p>
            <a href="rush.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/pinkish tulip.jpg" alt="Product 2">
            <h2>Pinkish Tulip</h2>
            <p>USD 42.000</p>
            <a href="pinktulip.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/love.jpg" alt="Product 3">
            <h2>Love</h2>
            <p>USD 113.000</p>
            <a href="love.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/mm.jpg" alt="Product 4">
            <h2>Merry Petals</h2>
            <p>USD 178.000</p>
            <a href="fallsun.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
      ...
      <div class="fall-sectionn">
        <div class="product-grid">
          <div class="product">
            ...
            <h2>A La Folie</h2>
            <p>USD 93.000</p>
            <a href="folie.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/falltwo.jpg" alt="Product 2">
            <h2>Yellow Puffs</h2>
            <p>USD 113.000</p>
            <a href="puffsyell.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/rain.jpg" alt="Product 3">
            <h2>Rainbow Feels</h2>
            <p>USD 89.000</p>
            <a href="rainbowfeels.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/ch.jpg" alt="Product 4">
            <h2>Christmas Glory</h2>
            <p>USD 119.000</p>
            <a href="glory.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
</div>
      ...
      <div class="fall-sectionnn">
        ...
        <div class="product-grid">
          <div class="product">
            ...
            <p>USD 195.000</p>
            <a href="cascading.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/barbie.jpg" alt="Product 2">
            <h2>Barbie World</h2>
            <p>USD 110.000</p>
            <a href="barbie.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/pinkper.jpg" alt="Product 3">
            <h2>Pink Perfection</h2>
            <p>USD 45.000</p>
            <a href="perfection.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/classy.jpg" alt="Product 4">
            <h2>Classy Reflex</h2>
            <p>USD 79.000</p>
            <a href="classy.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
      ...
      <div class="fall-sction">
        <div class="product-grid">
          <div class="product">
            ...
            <p>USD 750.000</p>
            <a href="inner.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/eleg.jpg" alt="Product 2">
            <h2>Rose Elegance</h2>
            <p>USD 70.000</p>
            <a href="rosele.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/color.jpg" alt="Product 3">
            <h2>Colorfull Dreams</h2>
            <p>USD 116.000</p>
            <a href="colorfull.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/magic.jpg" alt="Product 4">
            <h2>Magic Roses</h2>
            <p>USD 300.000</p>
            <a href="magic.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
      ...
      <div class="fall-sectionn">
        <div class="product-grid">
          <div class="product">
            ...
            <h2>Blushing</h2>
            <p>USD 86.000</p>
            <a href="blushh.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/moulin.jpg" alt="Product 2">
            <h2>Moulin Rouge</h2>
            <p>USD 100.000</p>
            <a href="rouge.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/soft.jpg" alt="Product 3">
            <h2>Soft Floral</h2>
            <p>USD 385.000</p>
            <a href="soft.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/bestsellfour.jpg" alt="Product 4">
            <h2>Only Roses</h2>
            <p>USD 200.000</p>
            <a href="rose.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
      ...
      <div class="fall-sectionn">
        <div class="product-grid">
          <div class="product">
            ...
            <h2>Rose Surprise</h2>
            <p>USD 32.000</p>
            <a href="surprise.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/sweett.jpg" alt="Product 2">
            <h2>For My SweetHeart</h2>
            <p>USD 70.000</p>
            <a href="sweet.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/sweet.jpg" alt="Product 3">
            <h2>Sweet Romance</h2>
            <p>USD 325.000</p>
            <a href="sweettwo.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/count.jpg" alt="Product 4">
            <h2>Count From 1 to 100</h2>
            <p>USD 300.000</p>
            <a href="countt.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="fall-sectionnn">
        ...
        <div class="product-grid">
          <div class="product">
            ...
            <h2>Shine Bright</h2>
            <p>USD 55.000</p>
            <a href="shinee.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/blushh.jpg" alt="Product 2">
            <h2>Blushing Petals</h2>
            <p>USD 113.000</p>
            <a href="blushingg.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/heart.jpg" alt="Product 3">
            <h2>Pink At Heart</h2>
            <p>USD 113.000</p>
            <a href="atheart.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/pinkyy.jpg" alt="Product 4">
            <h2>Red Pinky</h2>
            <p>USD 113.000</p>
            <a href="redpink.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
      ...
      <div class="fall-sction">
        <div class="product-grid">
          <div class="product">
            ...
            <h2>The Best</h2>
            <p>USD 355.000</p>
            <a href="thebest.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/sunshine.jpg" alt="Product 2">
            <h2>Sunshine</h2>
            <p>USD 55.000</p>
            <a href="sunshine.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/for.jpg" alt="Product 3">
            <h2>Sweety</h2>
            <p>USD 113.000</p>
            <a href="sweety.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/falalala.jpg" alt="Product 4">
            <h2>Falalala</h2>
            <p>USD 135.000</p>
            <a href="flala.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
      ...
      <div class="fall-sectionn">
        <div class="product-grid">
          <div class="product">
            ...
            <p>USD 80.000</p>
            <a href="cottage.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/joy.jpg" alt="Product 2">
            <h2>Joyfull Box</h2>
            <p>USD 119.000</p>
            <a href="joyfullbox.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/hot.jpg" alt="Product 3">
            <h2>Hot Pink</h2>
            <p>USD 100.000</p>
            <a href="hotpink.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/pearl.jpg" alt="Product 4">
            <h2>Pearl Of Pink</h2>
            <p>USD 80.000</p>
            <a href="pearlofpink.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
     </div>
      ...
      <div class="fall-sectionnn">
        ...
        <div class="product-grid">
          <div class="product">
            ...
            <p>USD 100.000</p>
            <a href="angel.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/white.jpg" alt="Product 2">
            <h2>White Heart</h2>
            <p>USD 200.000</p>
            <a href="whiteheart.php" class="add-to-cart">Add to Cart</a>
          ...
          <div class="product">
            ...
            <h2>Dreamy Wishes</h2>
            <p>USD 78.000</p>
            <a href="dreamywishes.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/softp.jpg" alt="Product 4">
            <h2>Soft Pearl</h2>
            <p>USD 112.000</p>
            <a href="soft pearl.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
      ...
      <div class="fall-sction">
        <div class="product-grid">
          <div class="product">
            ...
            <h2>1000 Mabrouk</h2>
            <p>USD 420.000</p>
            <a href="mbrk.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/peace.jpg" alt="Product 2">
            <h2>Peace And Love</h2>
            <p>USD 113.000</p>
            <a href="peace and love.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/bridesell.jpg" alt="Product 3">
            <h2>For All Your Love Bouquet</h2>
            <p>USD 150.000</p>
            <a href="foralllove.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/wwe.jpg" alt="Product 4">
            <h2>Winter Frost</h2>
            <p>USD 100.000</p>
            <a href="winterfrost.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="fall-sectionnn">
        ...
        <div class="product-grid">
          <div class="product">
            ...
            <h2>Charming Box</h2>
            <p>USD 90.000</p>
            <a href="charmingbox.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/happy.jpg" alt="Product 2">
            <h2>Happy Moments</h2>
            <p>USD 140.000</p>
            <a href="happymoment.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/bloom.jpg" alt="Product 3">
            <h2>Colorfull Bloom</h2>
            <p>USD 135.000</p>
            <a href="colorfullbloom.php" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/rosered.jpg" alt="Product 4">
            <h2>Red Rose</h2>
            <p>USD 75.000</p>
            <a href="redrose.php" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
      ...
      <div class="fall-sction">
        <div class="product-grid">
          <div class="product">
            ...
            <h2>Pop Up</h2>
            <p>USD 92.000</p>
            <a href="popup.html" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/sweetspring.jpg" alt="Product 2">
            <h2>Sweet Spring</h2>
            <p>USD 63.000</p>
            <a href="sweetspring.html" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/magenta.jpg" alt="Product 3">
            <h2>Rose Magenta</h2>
            <p>USD 119.000</p>
            <a href="rosemagneta.html" class="add-to-cart">Add to Cart</a>
          </div>
          <div class="product">
            <img src="photos/bouquets/art.jpg" alt="Product 4">
            <h2>Artistic Touch</h2>
            <p>USD 320.000</p>
            <a href="artistictouch.html" class="add-to-cart">Add to Cart</a>
          </div>
        </div>
      </div>
</div>
