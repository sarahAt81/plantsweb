...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/sweettt.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/sweettt.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/petl.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Sweety</h1>
        ...
        <p class="small-p">25 Fuchsia Baby Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        "Steal your love's heart with this beautiful bouquet of 25 fuchsia baby roses.
    </p>
  </div>
    </body>
    <footer>
