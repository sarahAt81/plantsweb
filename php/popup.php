...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/popup.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/popup.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/popup2.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Pop Up</h1>
        <p class="price"><span>USD 92</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Mixed Flowers in a Box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        This arrangement is like a garden full of freshly picked blossoms, our happy colored arrangement is a true delight. This mix of pink and orange flowers with a touch of greenery is creatively styled in our baby blue box. Send it today and add a breeze of freshness for their home.
<br><br>
Box Size: D=20cm.
<br><br>
Note: Box color or shape may vary upon availability.
    </p>
  </div>
