...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/softf.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/softf.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/ffs.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Soft Floral</h1>
        <p class="price"><span>USD 385</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">150 Mixed Roses in a Pot</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        These 150 flirty roses arrangement is an unforgettable gift for your recipient. Gracefully hand delivered, it will surely warm the heart of your special one.
<br><br>
Note: Roses mix of color may vary upon availability
<br><br>
