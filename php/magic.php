...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/fin.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/fin.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/magictwo.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Magic Roses</h1>
        <p class="price"><span>USD 300</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Bouquet of 140 Red Roses with Greenery</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Make a bold statement by sending this luxurious arrangement of 140 stemmed red roses to someone you adore.
        <br><br>
        This large arrangement is filled with 140 roses and captivating greenery guaranteed to bring a smile to her face.
        <br><br>
        Note: Pot shape or color may vary depending on availability.
        <br><br>
        Greenery used might vary.
    </p>
  </div>
