...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/con.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/con.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/km.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Count From 1 to 100</h1>
        ...
        <p class="small-p">Bouquet of 100 Red Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        How much do you love them? Count the ways from 1 to 100 with this lush bouquet of 100 romantic stem red roses, with additional greenery. This spectacular rose arrangement is artistically arranged to help express your feelings perfectly. A truly original gift your one-and-only will never forget.
