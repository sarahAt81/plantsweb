...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/blussss.jpg" alt="Big Photo" class="big-photo">
        <div class="hot-tag">SALE</div>
        <div class="small-photos">
            <img src="photos/bouquets/blusssss.jpg" alt="Small Photo 1" class="small-photo">
            <img src="photos/bouquets/blusssss.jpg" alt="Small Photo 2" class="small-photo">
          </div>
      </div>
