...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/sw.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/sw.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/twoswe.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">For My Sweetheart</h1>
        ...
        <p class="small-p">Bouquet of 12 Red Roses & Mixed Flowers</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        If you're crazy about someone and not afraid to show it, this special bouquet of 12 red roses and a mix of flowers with greenery is the perfect way to express your love. Make it even more impressive by choosing an add-on that would impress her!
    </p>
  </div>
