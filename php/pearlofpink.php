...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/pearll.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/pearll.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/pol.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Pearl Of Pink</h1>
        ...
        <p class="small-p">28 Roses & Greenery</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Surprise your lovely woman with this bouquet of 28 Roses  with greenery to make her the happiest girl!
    </p>
  </div>
    </body>
    <footer>
