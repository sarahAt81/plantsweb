...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/yellowp.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/yellowp.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/yell.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Yellow Puffs</h1>
    ...
    <p class="detail">
        Light up the mood of your special someone, with this vivid bouquet of 25 yellow Poly Roses, a real mood booster!
    </p>
  </div>
