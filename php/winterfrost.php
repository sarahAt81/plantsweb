...
<body>
    <div class="product-page">
        ...
        <div class="product-info">
            <h1 class="product-name">Winter Frost</h1>
            ...
            <p class="small-p">Elegant Bouquet</p>
        </div>
    </div>
    <div class="d">
        <p class="details"><strong>Details</strong></p>
        <p class="detail">
            Admire the gorgeous snow this winter with this bouquet made of 22 Roses and mixed flowers, a real mood booster for this Season!
        </p>
    </div>
