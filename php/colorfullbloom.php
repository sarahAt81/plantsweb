...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/bloomm.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/bloomm.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/zoomedbloom.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Colorfull Bloom</h1>
        <p class="price"><span>USD 135</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">16 Roses & Mixed Flowers in Box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Spoil your special one with this perfect gift of 16 Roses and other mixed flowers in a box. They will definitely appreciate something that is a little out of the ordinary.
<br><br>
        Box Size: S=30cm, H=18cm
    </p>
  </div>
