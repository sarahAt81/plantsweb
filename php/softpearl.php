...
<body>
    <div class="product-page">
        <div class="header">
            <img src="photos/bouquets/pearls.jpg" alt="Big Photo" class="big-photo">
            <div class="hot-tag">SALE</div>
            <div class="small-photos">
                <img src="photos/bouquets/pearls.jpg" alt="Small Photo 1" class="small-photo">
                <img src="photos/bouquets/pss.jpg" alt="Small Photo 2" class="small-photo">
            </div>
        </div>
        <div class="product-info">
            <h1 class="product-name">Soft Pearl</h1>
            <div class="price-container">
                <span class="original-price">$112.00</span>
                <span class="discount-label">20% off</span>
                <span class="sale-price">$89.60</span>
            </div>
            <hr class="thin-line">
            ...
            <p class="small-p">12 Roses & Eustoma Flowers in a Vase</p>
        </div>
    </div>
    <div class="d">
        <p class="details"><strong>Details</strong></p>
        <p class="detail">
            Soft luscious roses with equally mesmerizing white Eustomas form this elegant bouquet in a vase, fit for the
            most gentle, patient and compassionate ones.
        </p>
    </div>
