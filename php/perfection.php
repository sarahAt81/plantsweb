...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/perfect.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/perfect.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/opop.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Pink Perfection</h1>
        <p class="price"><span>USD 45</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">15 Roses with Eucalyptus</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Pink Perfection is a pop of pink that inspires beauty and joy. The mix of 15 roses of different shades of pink with a bunch of eucalyptus stems will lift anyone’s spirits and bring a smile to their lips.
    </p>
  </div>
