...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/cozz.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/cozz.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/cozyt.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">A La Folie</h1>
        <p class="price"><span>USD 93</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">24 Roses in a box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Send our "A La Folie" arrangement made of 24 roses to add a special touch to any occasion.
<br><br>
        Box Rectangular: L=30cm, W=12cm, H=10cm
    </p>
  </div>
