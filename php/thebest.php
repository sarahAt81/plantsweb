...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/best.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/best.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/bestt.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">The Best</h1>
        <p class="price"><span>USD 355</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Mix of 60 Roses in a Box</p>
      </div>
    </div>
    <div class="d">
    ...
    <p class="detail">
        ...
        Timeless, classy, and iconic, this pastel mix of 60 roses will surely put a smile on her face.
<br><br>
        Box size: D=50,H=30Cm.
        <br>
        Box color might change from white to black upon availability.
