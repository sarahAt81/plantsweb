...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/pinkpink.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/pinkpink.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/pinkj.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Pink At Heart</h1>
    ...
    <p class="detail">
        Add a little extra magic to your special girl's day!
<br><br>Check out this amazing bouquet of 25 Poly Roses, that will surely make them smile!
    </p>
  </div>
