...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/sweety.jpg" alt="Big Photo" class="big-photo">
      </div>
      <div class="product-info">
        <h1 class="product-name">Sweet Romance</h1>
        <p class="price"><span>USD 325</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">120 Roses in Terracotta Pot</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Sweet, sweet romance. An arrangement of 120 roses with shades of fuchsia and pink in a terracotta pot. The addition of dried stems makes it fall-appropriate.
    </p>
  </div>
