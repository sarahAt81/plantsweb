...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/obn.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/obn.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/nn.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Only Roses</h1>
        <p class="price"><span>USD 200</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">100 Long Stem Mixed Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Our exquisite bouquet of magnificent 100 long stem mixed color roses with no additional greenery, complements any occasion with unforgettable style.
<br><br>
        Note: Because only the freshest roses are selected for this arrangement, actual rose colors will vary due to local availability.
        <br><br>Our Roses are grown in our nursery in Lebanon; they are handpicked and delivered fresh every day to our stores.
    </p>
  </div>
