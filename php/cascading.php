...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/casc.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/casc.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/casd.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Cascading Roses</h1>
        <p class="price"><span>USD 195</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">80 Mixed Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Unwrap Elegance: Our exquisite box of mix 80 roses is more than a gift; they're an enchanting experience. Elevate any occasion with the timeless beauty and heartfelt sentiments that only a box of roses can convey!
<br><br>
        Box Size: D=30cm, H=18cm
        <br><br>
        Note: Box color might be changed from White to Black upon availability.
    </p>
  </div>
