...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/blushingpetal" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/blushingpetal.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/blushingpetal1.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Blushing Petal</h1>
