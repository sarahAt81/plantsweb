...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/barbieworld.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/barbieworld.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/worldd.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Cozy Box</h1>
        ...
        <p class="small-p">Roses & Baby Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Step into a world of enchantment with our Barbie World box of 20 Roses mixed with Baby Roses. Embrace the elegance of these rosy delights, fit for a modern-day princess.
  <br><br>
        Box Size: D20 H15Cm
    </p>
  </div>
