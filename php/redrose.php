...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/roseree.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/roseree.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/redr.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Red Rose</h1>
        <p class="price"><span>USD 75</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">12 Red Roses & Other Flowers in Box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Bright, blooming and ready to show your desire, hope and love to your other half! <br><br>
        Send this astonishing arrangement of 12 red roses mixed with a variety of red flowers and black gypsophile in round box.
<br><br>
Box size: D20 x H15 cm
    </p>
  </div>
