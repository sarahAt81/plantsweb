...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/lovem.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/lovem.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/lovemm.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Madness of Love</h1>
        <p class="price"><span>USD 750</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Bouquet of 250 Red Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Send this amazing bouquet of 250 red roses to show your care and express your devotion to the love of your life!
<br><br>
Note: Shades of red roses may vary from vivid red to dark red upon availability.
    </p>
  </div>
