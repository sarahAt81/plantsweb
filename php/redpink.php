...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/pinkred.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/pinkred.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/redp.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Red Pinky</h1>
        ...
        <p class="small-p">25 Stems of Baby Roses</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        This mix of 25 stems of stylish pink and fuchsia baby roses make a charming gift for anniversaries, birthdays or any day you want to send someone little kisses and surprise them with a smile.
<br><br>
Note: the baby roses may be delivered in buds. They will open up in a warm room.
    </p>
  </div>
