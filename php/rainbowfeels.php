...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/rainboww.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/rainboww.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/feelss.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Rainbow Feels</h1>
        <p class="price"><span>USD 89</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Mixed Flowers</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        his box of wonders filled with the rich colors of mixed flowers, makes this season special for your loved ones.
        <br><br>
