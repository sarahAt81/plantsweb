...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/orrrr.jpg" alt="Big Photo" class="big-photo">
      ...
      <div class="product-info">
        ...
        <div class="price-container">
          ...
          <span class="sale-price">$86.40</span>
        </div>
        <hr class="thin-line">
        ...
        <p class="small-p">10 Roses & Mixed Flowers Bouquet</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Send this vivid bouquet of 10 roses and mixed flowers to thank them for all the love they share with you!
