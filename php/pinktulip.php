...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/pinktt.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/pinktt.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/tpinkk.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Pinkish Tulip</h1>
        <p class="price"><span>USD 42</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">12 Pink Tulips Bouquet</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Surprise your loved one with a 12 mixed tulip bouquet & put a smile on their face.
 <br><br>
Note: Tulips actual color may vary depending on availability.
The bouquet might be delivered in bud. The tulips will develop and open up in a warm room
 <br><br>
        Box Size: S=20cm, H=10cm
    </p>
  </div>
