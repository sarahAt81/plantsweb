...
<body>
    <div class="product-page">
        <div class="header">
            <img src="photos/bouquets/mabrook.jpg" alt="Big Photo" class="big-photo">
            <div class="hot-tag">SALE</div>
            <div class="small-photos">
                <img src="photos/bouquets/mabrook.jpg" alt="Small Photo 1" class="small-photo">
                <img src="photos/bouquets/mbrkk.jpg" alt="Small Photo 2" class="small-photo">
            </div>
        </div>
        <div class="product-info">
            <h1 class="product-name">1000 Mabrouk</h1>
            <div class="price-container">
                <span class="original-price">$420.00</span>
                <span class="discount-label">20% off</span>
                <span class="sale-price">$336.00</span>
            </div>
            <hr class="thin-line">
            ...
            <p class="small-p">40 Roses & Mixed Flowers in Vase</p>
        </div>
    </div>
    <div class="d">
        <p class="details"><strong>Details</strong></p>
        <p class="detail">
            Whether your celebrating your relationship or congratulating a newlywed couple, choose this extravagant
            arrangement of 40 roses and other mixed flowers topping an elegant glass vase.
            <br><br>
            Vase Size: H= 55cm, D= 30cm
