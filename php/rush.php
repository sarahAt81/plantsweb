...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/rushh.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/rushh.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/rusho.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Rush Of Feelings</h1>
        <p class="price"><span>USD 380</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">100 Roses & Other Flowers in Large Box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Discover this season's treasures with this astonishing arrangement of 100 Roses and mixed flowers in a large box.
<br><br>
        Box Size: D=50cm, H=30cm
    </p>
  </div>
