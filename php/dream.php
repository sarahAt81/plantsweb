...
<body>
    <div class="product-page">
        <div class="header">
            <img src="photos/bouquets/d.jpg" alt="Big Photo" class="big-photo">
        ...
        <div class="product-info">
            ...
            <div class="price-container">
                ...
                <span class="sale-price">$62.40</span>
            </div>
            <hr class="thin-line">
    ...
    <div class="d">
        ...
        <p class="detail">
            Treat your loved ones to this special wintry scene.
            <br><br>
            A charming bouquet of 12 white roses and other flowers, to bring holiday magic!
...
<footer>
    ...
    <div class="footer-bottom">
        <p>&copy; Charming Mixed Flowers Bouquet </p>
