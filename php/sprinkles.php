...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/bbs.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/bbs.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/bd.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Baby Sprinkles</h1>
        <p class="price"><span>USD 142</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">25 Poly Roses in Vase</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        These multi color blooms bouquet made of 25 poly roses in a vase gives your loved one a moment of peace, as if going on a tour in the garden!
<br><br>
Note: Vase shape may vary
Mix of Poly Roses color will vary depending on availability. 
    </p>
  </div>
