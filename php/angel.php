...
<body>
  <div class="product-page">
    <div class="header">
      <img src="photos/bouquets/aaa.jpg" alt="Big Photo" class="big-photo">
      <div class="small-photos">
        <img src="photos/bouquets/aaa.jpg" alt="Small Photo 1" class="small-photo">
        <img src="photos/bouquets/aa.jpg" alt="Small Photo 2" class="small-photo">
      </div>
    </div>
    <div class="product-info">
      <h1 class="product-name">Guardian Angel</h1>
      ...
      <p class="small-p">50 White Roses Bouquet</p>
    </div>
  </div>
  <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
      White roses convey sentiments such as love, friendship, respect and hope! Make someone smile with this bouquet of
      50 white roses with no additional greenery!
      <br><br>
      Note: Our Roses are grown in our nursery in Lebanon; they are handpicked and delivered fresh every day to our
      stores.
    </p>
  </div>
