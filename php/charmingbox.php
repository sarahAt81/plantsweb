...
<body>
    <div class="product-page">
      <div class="header">
        <img src="photos/bouquets/charm.jpg" alt="Big Photo" class="big-photo">
        <div class="small-photos">
          <img src="photos/bouquets/charm.jpg" alt="Small Photo 1" class="small-photo">
          <img src="photos/bouquets/charmm.jpg" alt="Small Photo 2" class="small-photo">
        </div>
      </div>
      <div class="product-info">
        <h1 class="product-name">Charming Box</h1>
        <p class="price"><span>USD 90</span></p>
        <hr class="thin-line">
        ...
        <p class="small-p">Mixed Flowers in Box</p>
      </div>
    </div>
    <div class="d">
    <p class="details"><strong>Details</strong></p>
    <p class="detail">
        Gift a touch of class and sophistication with this box of Eustoma, Muflier and other flowers, perfect for expressing refined taste and grace.
<br><br>
